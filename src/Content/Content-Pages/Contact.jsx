...
<div className={ContactCSS.ContactPage}>
    ...
    <div className={ContactCSS.content}>
          <div className={ContactCSS.contactInfo}>
              <h1>CONTACT INFO</h1>
              <ul>
                <li><span style={{color:"#E2AE1B"}}><EmailIcon/></span> <span>arjunsen717@gmail.com</span></li>
                <li><span style={{color:"#E2AE1B"}}><PhoneIcon/></span> <span>+91 9851455712</span></li>
                <li><span style={{color:"#E2AE1B"}}><FaMapMarkerAlt /></span> <span>Raniganj, West Bengal, India</span></li>
              </ul>
          </div>
