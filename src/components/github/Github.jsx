  ...
  return (
    <div className={styles.gitBox} >
      ...
      <div className={styles.Github}>
        <GitHubCalendar username="arjunsen1999" className="calender" />
      </div>
      <div className={styles.Github1}>
        <a href="https://github.com/arjunsen1999" rel="noreferrer" target="_blank">
          <img
            alt="7oSkaaa's Github Stats"
            src="https://github-readme-stats.vercel.app/api?username=arjunsen1999&show_icons=true&count_private=true&theme=algolia"
            height="192px"
          />
        </a>
      </div>
